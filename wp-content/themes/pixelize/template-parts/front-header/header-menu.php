...
<div class="wp-block wp-block-kubio-dropdown-menu  position-relative wp-block-kubio-dropdown-menu__outer pixelize-front-header__k__c6BbujDIAOY-outer pixelize-local-150-outer kubio-dropdown-menu h-ignore-global-body-typography <?php echo $component->printHeaderMenuClasses(); ?>" data-kubio="kubio/dropdown-menu" data-kubio-component="dropdown-menu" data-kubio-settings="[]">
  ...
  'wrapper_class' => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row pixelize-front-header__k__0xSC3AT64-container pixelize-local--container',
  'logo_image_class' => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  pixelize-front-header__k__0xSC3AT64-image pixelize-local--image',
  'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   pixelize-front-header__k__0xSC3AT64-alternateImage pixelize-local--alternateImage',
  'logo_text_class' => 'position-relative wp-block-kubio-logo__text  pixelize-front-header__k__0xSC3AT64-text pixelize-local--text',
)); ?>
										</div>
									</div>
								</div>
