<?php
$pixelize_theme_svg_icons = array(
	'fort-awesome'         => array(
...
$pixelize_theme_divider_style = array(
...
$pixelize_title                         =  'Aspire. Build. Achieve.';
$pixelize_subtitle                      =  'Lorem ipsum dolor sit amet, at mei dolore tritani repudiandae. In his nemore temporibus consequuntur. Vim ad prima vivendum consetetur. Viderer feugiat at pro, mea aperiam.';
$pixelize_theme_action_button           =  'Start Your Journey';
$pixelize_theme_action_button_secondary =  'Contact us';

$defaults = array(
	'default_icon'                      => $pixelize_theme_svg_icons['fort-awesome'],
	'icons'                             => $pixelize_theme_svg_icons,
	'divider_style'                     => $pixelize_theme_divider_style,
	'gradients'                         => $pixelize_gradients,

	'assets_js_key'                     => 'kubioFrontendData',

	'edit_this_text_in_customizer'      => $pixelize_title,
	'lorem_ipsum'                       => $pixelize_subtitle,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $pixelize_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $pixelize_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value'      => $pixelize_title,
			'localProps' => array(
				'content' => $pixelize_title
			),
			'style' => array(
				'descendants' => array(
					'text' => array(
		...
		'subtitle'     => array(
			'show'  => true,
			'value'      => $pixelize_subtitle,
			'localProps' => array(
				'content' => $pixelize_subtitle
			),
			'style' => array(
				'descendants' => array(
					'text' => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $pixelize_gradients['night_fade'],
									'gradient_opacity' => 100,
									'shape'            =>
										array(
											'value'  => 'right-tilted-lines',
											'isTile' => false,
										),
									"light"            => 87
								),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $pixelize_theme_svg_icons['facebook-square-full'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $pixelize_theme_svg_icons['twitter-x'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $pixelize_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $pixelize_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $pixelize_theme_svg_icons['map-marker'],
						'text'       => '123, Main Street, City, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $pixelize_theme_svg_icons['phone'],
						'text'       => '+1 234 567 890',
						'link_value' => 'tel:+1 234 567 890',
						'index'      => 0,
					),
					array(
						'icon'       => $pixelize_theme_svg_icons['envelope'],
	...
	'header'                            => array(
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					...
					array(
						'icon'       => $pixelize_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $pixelize_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $pixelize_theme_svg_icons['phone-square'],
